    ...
    <div class="main-left col-span-3 space-y-4">
      <div class="bg-white border border-gray-200 rounded-lg">
        <div class="p-4 flex space-x-4">
          <input class="p-4 w-full bg-gray-100 rounded-lg" placeholder="What are you looking for?" type="search">

          <a class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg" href="#">Post</a>
        </div>
      </div>
      ...
      <div class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-4 gap-4">
        <div class="p-4 text-center bg-gray-100 rounded-lg">
          <img class="mb-6 rounded-full" src="https://i.pravatar.cc/300?img=70">
      ...
      <div class="p-4 bg-white border border-gray-200 rounded-lg">
        <div class="mb-6 flex items-center justify-between">
          <div class="flex items-center space-x-6">
            <img class="w-[40px] rounded-full" src="https://i.pravatar.cc/300?img=70">
